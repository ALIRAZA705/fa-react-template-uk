        ...
        <React.Fragment >
            <TableRow style={{height:"70px"}}
             onClick={() => {
                ...
                <TableCell component="th" scope="row" style={{ paddingTop: 20 }} > {row.cancelled.date} </TableCell>
                <TableCell align="left" >{row.cancelled.club_name}</TableCell>
                <TableCell align="left">{row.cancelled.contacts}</TableCell>
                <TableCell align="left">{row.cancelled._staff}</TableCell>
                <TableCell align="left">{row.cancelled.status}</TableCell>
                <TableCell align="left">{row.cancelled.staff}</TableCell>
                <TableCell align="left">{row.cancelled.visit_summary}</TableCell>
            </TableRow>
        </React.Fragment>
    );
}

export default function EngagementCancelled() {
