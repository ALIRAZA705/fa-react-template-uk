        ...
        <React.Fragment >
            ...
            <TableRow style={{height:"70px"}}
             onClick={() => {
                ...
                <TableCell component="th" scope="row" style={{ paddingTop: 20 }} > {row.completed.date} </TableCell>
                <TableCell align="left" >{row.completed.club_name}</TableCell>
                <TableCell align="left">{row.completed.contacts}</TableCell>
                <TableCell align="left">{row.completed._staff}</TableCell>
                <TableCell align="left">{row.completed.status}</TableCell>
                <TableCell align="left">{row.completed.staff}</TableCell>
                <TableCell align="left">{row.completed.visit_summary}</TableCell>
            </TableRow>
        </React.Fragment>
    );
}

export default function EngagementComplete() {
